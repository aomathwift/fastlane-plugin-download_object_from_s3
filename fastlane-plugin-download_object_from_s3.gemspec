...
require 'fastlane/plugin/download_object_from_s3/version'

Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-download_object_from_s3'
  spec.version       = Fastlane::DownloadObjectFromS3::VERSION
  spec.author        = 'aomathwift'
